...
import Parsing (ParseError(..), initialPos, parseErrorMessage)
...
component =
      ...
      [ HH.div
          ...
          [ HH.div
              ...
              [ HH.input
                  ...
                  , HE.onValueInput (\newInput -> (ChangeInput newInput))
                  , HE.onFocusOut (\_ -> Cancel)
  ...
  handleAction = case _ of
    ...
    ChangeInput newInput -> H.modify_
      ( case _ of
          Inactive -> Inactive
