...
component :: forall m. MonadAff m => H.Component Query {} Void m
component = H.mkComponent
  ...
  render { route } = case route of
    Just r -> case r of
      Route.Home ->
        HH.slot (Proxy :: _ "home") unit CP.component {} absurd
      Route.Problem nr ->
        case P.getProblem P.problems nr of
          Nothing ->
            HH.div_ [ HH.text "Oh no! I don't know this problem." ]
          Just problem ->
            HH.slot (Proxy :: _ "problem") unit SP.component problem absurd
    Nothing ->
